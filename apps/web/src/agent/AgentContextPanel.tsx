import { BookOpen, Boxes, FileClock, Wrench } from 'lucide-react'

export default function AgentContextPanel({ projectTitle, chapterTitle, chapterVersion, nodeCount, edgeCount }: {
  projectTitle: string
  chapterTitle: string
