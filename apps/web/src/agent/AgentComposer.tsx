...
export default function AgentComposer({ prompt, scope, disabled, hasProvider, hasChapter = true, onPromptChange, onScopeChange, onRun, onHealth, onOpenSettings }: {
  ...
  return (
    <div className="space-y-3 border-b border-slate-200 p-4">
      ...
      {!hasProvider && <p className="text-xs leading-5 text-amber-700">未配置模型时仍可自然对话、盘点项目、查询角色素材和检查剧情；续写与润色需要外部模型。 <button type="button" onClick={onOpenSettings} className="font-semibold underline underline-offset-2">前往模型设置</button></p>}
