...
| 状态 | 可以直接完成 | 适合的任务 |
|---|---|---|
| 未配置 API Key | 项目/章节/素材盘点、剧情体检、创作知识问答、确定性续写草稿、正文结构化转换、素材提示词 | 快速梳理故事，把用户或 Agent 已有正文转换为可审核的场景、旁白、角色台词和选项 |
...
- 当前是本地单用户工作台，不包含多人实时协作、在线 TTS/配音生成、波形剪辑、逐字字幕同步或完整多轨 BGM 时间线；已支持镜头级 BGM、音效和手动配音绑定。
